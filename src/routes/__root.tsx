...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Appliance Repair Rawalpindi | Faizan Repairing Centre and Home Appliances" },
      {
        name: "description",
        content:
          "Professional appliance, AC and electronics repair services in Rawalpindi & Islamabad. Available 24/7.",
      },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Faizan Repairing Centre and Home Appliances" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          areaServed: ["Rawalpindi", "Islamabad"],
